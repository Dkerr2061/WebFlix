...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        movie1 = Movie(name='The Cabin in the Woods', image='https://m.media-amazon.com/images/I/81+TuC6oQ8L._AC_UF350,350_QL50_.jpg', year=2011, director='Drew Goddard', description="Five teenagers head off for a weekend at a secluded cabin in the woods. They arrive to find they are quite isolated with no means of communicating with the outside world. When the cellar door flings itself open, they of course go down to investigate. They find an odd assortment of relics and curios, but when one of the women, Dana, reads from a book, she awakens a family of deadly zombie killers. However, there's far more going on than meets the eye.", price=16.99)

        movie2 = Movie(name="Fear and Loathing in Las Vegas", image="https://m.media-amazon.com/images/I/71bzrdGNELL._AC_UF894,1000_QL80_.jpg", year=1998, director="Terry Gilliam", description="The big-screen version of Hunter S. Thompson's seminal psychedelic classic about his road trip across Western America as he and his large Samoan lawyer searched desperately for the \"American dream\"... they were helped in large part by the huge amount of drugs and alcohol kept in their convertible, The Red Shark.", price=10.99)
